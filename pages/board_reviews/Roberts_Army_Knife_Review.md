...
- **Best setup:** Futures F8 thruster (large, neutral template)
- **Worst setup:** Twin + trailer (way too loose)
- **Quad setups:** Tried Stretch Quads, honeycomb, Alpha, and NVSG10 constructions. All felt stiff or still pivoty.  
- **Thruster setups tested:** AM2 (large), F6, P6, F8 — F8 was the clear winner.
...
- **Sweet spot:** Stomach high and up
- **Grovel range:** Waist to thigh high if there’s a decent wall
- **Not ideal for:** Tight barrels or hollow sandbar setups
...
- **Volume:** A bit more than I’d like. I wish it were thinner.
- **Duck diving:** Surprisingly easy given the float.
- **Nose shape:** Pulled in, which I love for a groveler/daily driver.
- **Tail:** Narrower than I usually prefer, but it helps in bigger or hollower surf.
- **Swing weight:** Low. Doesn’t hang in the lip or feel sluggish on turns.
